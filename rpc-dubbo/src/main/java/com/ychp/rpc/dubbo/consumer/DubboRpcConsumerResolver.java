package com.ychp.rpc.dubbo.consumer;
 ...
 */
@Slf4j
public class DubboRpcConsumerResolver implements RpcConsumerResolver {
    private Map<String, Object> references = Maps.newHashMap();
    private final ApplicationContext applicationContext;
    private final DubboProperties properties;

    public DubboRpcConsumerResolver(ApplicationContext applicationContext, DubboProperties properties) {
